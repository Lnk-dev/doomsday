  ...
  return (
    <article className="px-4 py-3">
      ...
      <div className="flex flex-col items-center">
        ...
        >
          {author.avatar && (
            <img src={author.avatar} alt={`${author.username}'s avatar`} className="w-full h-full object-cover" />
          )}
        </div>
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              aria-label={`More options for post by ${author.username}`}
              className="p-1 -mr-1 text-[#777] hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded-full"
            >
        ...
        {isQuoteRepost && originalPost && (
          <div
            ...
            aria-label={`Quoted post from ${originalPost.author.username}`}
          >
        ...
        <div className="flex items-center gap-1 mt-3 -ml-2" role="group" aria-label="Post actions">
          ...
          <button
            ...
            className="p-2 hover:bg-[#1a1a1a] rounded-full transition-colors group focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
          >
            <Heart
              size={20}
              aria-hidden="true"
          ...
          {/* Comment button */}
          <button
            aria-label={`Comment on post, ${replies} replies`}
            className="p-2 hover:bg-[#1a1a1a] rounded-full transition-colors group focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
          >
            <MessageCircle
              size={20}
          ...
          <div className="relative" ref={repostMenuRef}>
            <button
              ...
              aria-label={isReposted ? `Undo repost, ${repostCount} reposts` : `Repost options, ${repostCount} reposts`}
            ...
            {showRepostMenu && (
              <div
                ...
                className="absolute left-0 top-full mt-1 bg-[#262626] rounded-xl shadow-lg border border-[#333] py-1 min-w-[160px] z-10"
              >
                <button
                  role="menuitem"
                  onClick={() => {
                  ...
                  className="w-full px-4 py-2.5 text-left text-[15px] text-white hover:bg-[#333] flex items-center gap-3 focus:outline-none focus-visible:bg-[#333]"
                >
